"""Banner & branding untuk TH0RSC4N."""
...
def show_banner():
    ...
    console.print(f"[bright_green]           v{__version__}  |  by Thorranov  |  Security Researcher[/bright_green]")
...
def show_scan_header(target, modules_count, mode_info=None):
    ...
    if mode_info:
        mode_line = (
            f"\n[bold bright_green]  MODE    [/bold bright_green]"
            f"[bright_green]|[/bright_green] "
            f"[bold white]{mode_info['icon']} {mode_info['name']}[/bold white] "
            f"[dim white]({mode_info['eta']})[/dim white]"
        )
    ...
    console.print(
        f"[bold bright_green]  MODULES [/bold bright_green][bright_green]|[/bright_green] "
        f"[bold white]{modules_count} scenarios[/bold white]{mode_line}"
    )
    console.print(f"[bold bright_green]{'═' * 72}[/bold bright_green]")
    console.print()
...
def show_scan_complete(stats, elapsed):
    ...
    console.print(f"[bold bright_green]{'═' * 72}[/bold bright_green]")
    console.print(
        f"[bold bright_green]  STATUS  [/bold bright_green][bright_green]|[/bright_green] "
        f"[{color}]{status}[/{color}]"
    )
    console.print(
        f"[bold bright_green]  CHECKS  [/bold bright_green][bright_green]|[/bright_green] "
        f"[bold white]{total}[/bold white]"
    )
    console.print(
        f"[bold bright_green]  TIME    [/bold bright_green][bright_green]|[/bright_green] "
