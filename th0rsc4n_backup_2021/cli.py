"""
TH0RSC4N -Web Security Scanner OWASP Top 10 2025
by Thorranov | Security Researcher
...
def cli(ctx):
    ...
    \b
    ╔═══════════════════════════════════════════════════════════╗
    ║   TH0RSC4N - Web Security OWASP Top 10 2025 Scanner       ║
    ║   by Thorranov | Security Researcher                      ║
    ╚═══════════════════════════════════════════════════════════╝

    \b
    Sebuah CLI tool untuk audit keamanan website dengan 80+ skenario
    OWASP Top 10 2025 + teknologi fingerprinting (150+ tech).
