...
ALL_MODULES = [
    ...
    ("A01:2021 - Broken Access Control", m01_bac.scan),
    ("A02:2021 - Cryptographic Failures", m02_crypto.scan),
    ("A03:2021 - Injection", m03_injection.scan),
    ("A04:2021 - Insecure Design", m04_design.scan),
    ("A05:2021 - Security Misconfiguration", m05_misconfig.scan),
    ("A06:2021 - Vulnerable Components", m06_components.scan),
    ("A07:2021 - Auth Failures", m07_auth.scan),
    ("A08:2021 - Integrity Failures", m08_integrity.scan),
    ("A09:2021 - Logging Failures", m09_logging.scan),
    ("A10:2021 - SSRF", m10_ssrf.scan),
